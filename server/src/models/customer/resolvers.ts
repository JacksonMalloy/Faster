...
export const CustomerQueries = {
  ...
  customersByTenant: async (parent: any, { tenantId }: { tenantId: number }, context: any, info: any) => {
    const customerRepository = new CustomerRepository()
...
export const CustomerMutations = {
  registerCustomer: async (parent: any, args: RegistrationArgs, context: any, info: any) => {
    const customerRepository = new CustomerRepository()
    const data = await customerRepository.registerCustomer(args)
    return data
  },
  loginCustomer: async (parent: any, args: LoginArgs, context: any, info: any) => {
    const customerRepository = new CustomerRepository()
    const data = await customerRepository.loginCustomer(args)
    return data
  },
  deleteCustomer: async (parent: any, { customerId }: { customerId: number }, context: any, info: any) => {
    const customerRepository = new CustomerRepository()
    const data = await customerRepository.deleteCustomer(customerId)
    return data
  },
  connectCustomerToTenant: async (parent: any, args: ConnectCustomerWithOrgArgs, context: any, info: any) => {
    const customerRepository = new CustomerRepository()
